...
async def validate_submenu(db: AsyncSession, target_menu_id: str, target_submenu_id: str):
...
async def validate_dish(db: AsyncSession, target_menu_id: str, target_submenu_id: str, target_dish_id: str):
    await validate_submenu(db=db, target_menu_id=target_menu_id, target_submenu_id=target_submenu_id)
